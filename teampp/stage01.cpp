...
HRESULT stage01::init()
{
	...
	_Stage1RightDoorOpen._StageImage = IMAGEMANAGER->addImage("Door_Stage1", "images/stage/UI_UnLocked_Door.bmp", 78, 114, true, RGB(255, 0, 255));

	_Stage1RightDoorOpen._x = WINSIZEX + 150;
	_Stage1RightDoorOpen._y = WINSIZEY / 2 - 50;
	...
	_Stage1RightDoor._StageImage = IMAGEMANAGER->addImage("Door2_Stage1", "images/stage/UI_UnLocked_Door2.bmp", 78, 114, true, RGB(255, 0, 255));
...
void stage01::render()
{
	...
	IMAGEMANAGER->findImage("Door2_Stage1")->render(getMemDC(), _Stage1RightDoor._x - 39, _Stage1RightDoor._y - 57);
}
