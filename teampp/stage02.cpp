...
HRESULT stage02::init()
{
	...
	_Stage2RightDoorOpen._x = WINSIZEX + 560;
	...
	_Stage2RightDoor._x = WINSIZEX + 560;
...
void stage02::render()
{
	...
	IMAGEMANAGER->findImage("Door2_Stage2")->render(getMemDC(), _Stage2RightDoor._x + 5, _Stage2RightDoor._y - 173);
...
{
	IMAGEMANAGER->findImage("Door_Stage2")->render(getMemDC(), _Stage2RightDoor._x + 5, _Stage2RightDoor._y - 173);
}
